<template>
	<el-dialog v-model="dialogVisible" modal :title="dialogProps.title" width="30%" draggable>
		<el-form ref="ruleFormRef" :disabled="dialogProps.isView" :model="dialogProps.rowData" :rules="rules"
		...
		<el-row justify="space-around">
			<el-col :span="6">
				<el-button type="primary" :disabled="dialogProps.isView" @click="submitForm(ruleFormRef)"> 保存
				</el-button>
			</el-col>
			<el-col :span="6">
